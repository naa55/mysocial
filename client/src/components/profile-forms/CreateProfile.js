  ...
  return (
    <Fragment>
      <form action="" className="" onSubmit={e => onSubmit(e)}>
        ...
        <h5 style={{ color: "red" }}>Only for Health Practitioners</h5>
        ...
        {displaySocialInputs && (
          <Fragment>
            <div className="social-input t">
              <i className="fab fa-twitter fa-2x icon" />
              <input
                className="sign"
                type="text"
                placeholder="Twitter URL"
            ...
            <div className="form-group social-input">
              <i className="fab fa-linkedin fa-2x icon" />
              <input
                className="sign"
                type="text"
                placeholder="Linkedin URL"
